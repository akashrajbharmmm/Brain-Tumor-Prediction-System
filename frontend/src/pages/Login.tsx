    ...
    <div className="min-h-screen bg-[#F8F7F4] flex">
      <div className="hidden lg:flex lg:w-1/2 bg-[#0F172A] flex-col justify-between p-12">
        ...
        <div>
          <h2 className="text-white text-3xl font-semibold leading-snug mb-3">
            MRI-based tumor classification, built for research and review.
          </h2>
          <p className="text-slate-400 text-sm max-w-sm">
            Upload a scan, get a model prediction with confidence scoring and visual explanation.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          <h1 className="text-2xl font-semibold text-[#0F172A] mb-1">Sign in</h1>
          <p className="text-slate-500 text-sm mb-8">Access your scan history and dashboard</p>
          ...
          <p className="text-sm text-slate-500 mt-6">
            No account? <Link to="/register" className="text-teal-700 font-medium">Create one</Link>
          </p>
        </div>
      </div>
    </div>
